...
//! by trying every route. However, [Problem 67](https://projecteuler.net/problem=67),
//! is the same challenge with a triangle containing one-hundred rows;
//! it cannot be solved by brute force, and requires a clever method! ;o)
//!
//! [Problem 18 on projecteuler.net](https://projecteuler.net/problem=18)
//!
...
/// Calculate solution to Problem 18
